...
class JanLindersScraper(BaseScraper):
    SHORT_NAME = "janlinders"
    LONG_NAME = "Jan Linders"
    BASE_URL = "https://www.janlinders.nl/"
    ...
    def __init__(
        ...
        """
        Initialize the JanLindersScraper instance.
        ...
        self.products_sitemap_url = products_sitemap_url or urljoin(self.base_url, "")
