...
const Footer: NextPage = () => {
  ...
  return (
    <footer className="self-stretch bg-darkgray flex
      ...
      <div className="flex flex-row md:flex-col items-center justify-start w-full pb-[35px] relative">
        <div className="w-[25%] flex flex-col items-center justify-start">
          <div className="self-stretch relative">Nijmegen, the Netherlands</div>
        </div>
        <div className="flex-1 relative h-auto flex flex-row md:flex-col">
          <div className="w-[33%] md:w-[90%] md:py-15 flex flex-col items-start justify-start gap-[40px]">
          ...
          <div className="w-[34%] md:w-[90%] md:py-15 relative flex flex-col gap-[40px] items-start">
            ...
            <div className="self-stretch flex flex-row md:flex-col gap-[10px]">
              <TextField
                  ...
                  variant="outlined"
                />
              <button className="cursor-pointer [border:none] p-0 bg-[transparent] w-auto h-6 overflow-hidden shrink-0 flex flex-col items-start justify-end gap-[3px]">
      ...
      <div className="flex flex-col items-start justify-center gap-[35px] text-left text-black">
