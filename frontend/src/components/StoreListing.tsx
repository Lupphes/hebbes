...
const StoreListing: NextPage<itemList> = ({ singleStores }) => {
    ...
    return (
        <div className="flex flex-row snap-x items-center justify-start gap-7 text-center text-smi">
            ...
            {singleStores.map((product: singleStore, index: number) => (
              <div key={product.price} className="snap-start flex flex-col place-items-center gap-4">{/*Change this to unique identifier TODO*/}
