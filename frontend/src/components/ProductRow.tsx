...
const ProductRow: NextPage<{item: Item}> = ({ item }) => {
  return (
    <div
      className="flex flex-row text-center text-lg text-black font-poppins"
    >
      <div className="flex flex-row w-1/8 sm:flex-col sm:w-full">
        <div className="overflow-hidden flex flex-row justify-between">
          ...
          />
          <div className="flex flex-col W-1/4 items-center justify-center gap-[12px]">
