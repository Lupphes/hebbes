    ...
    <div className="flex flex-row sm:flex-col text-center text-lg text-black font-poppins gap-7">
      <div className="flex flex-row
        ...
        <div className="flex flex-col w-3/4 sm:w-[80%] justify-start gap-[12px] pt-4 md:justify-center sm:justify-center">
          <a onClick={() => ClickableProductRow(item.id)} className="flex justify-self-start">
            {item.name}
          </a>
          <svg onClick={() => ClickAbleBasket(item)} className="h-6 text-darkolivegreen-100 justify-self-start md:justify-self-center" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
